...
//   const percentFromPrice = 50; // Max down from price
//   const maxAmountOrders = 6;
...
//   const loadBalances = () => {
//     return getAccountData(ACCESS_KEY, SECRET_KEY, {}).then(account=>{
...
//     const openOrders = [...pairs.BTCUSDT.openOrders];
//     const directionMove = pairs.BTCUSDT.directionMove;
//     const firstOrder = openOrders[0] || [];
//     const firstLastOrder = openOrders.length ? openOrders[openOrders.length-1] : [];

//     const percentBetweenOrders = firstOrder.price / 

//     if (!openOrders.length) {
//       // const amountOfTransaction = currency.USDT.balance / maxAmountOrders;
//       pairs.BTCUSDT.directionMove = 'UP';
//       preparingOrder('BTCUSDT', 'buy', lastPrices);
//       return;
//     };
